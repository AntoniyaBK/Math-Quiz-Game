...
public class Multiplication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = findViewById(R.id.textViewScor);
        life = findViewById(R.id.textViewLi);
        time = findViewById(R.id.textViewTi);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String userInput = answer.getText().toString().trim();

                if (!userInput.isEmpty() && userInput.matches("\\d+")) {
                    userAnswer = Integer.valueOf(userInput);
